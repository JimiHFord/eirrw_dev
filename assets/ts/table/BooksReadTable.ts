...
export class BooksReadTable extends AbstractTable<ResultRow> {
    ...
    protected addRow(rowData: ResultRow): HTMLElement {
        ...
        let series = rowData.recommendSeries ? 
            `<svg fill="currentcolor" class="w-5 h-5" viewBox="0 0 32 32" id="Flat" xmlns="http://www.w3.org/2000/svg">
        ...
        let book = rowData.recommendBook ?
            `<svg viewBox="0 0 20 20" class="w-5 h-5" fill="currentcolor" xmlns="http://www.w3.org/2000/svg">
